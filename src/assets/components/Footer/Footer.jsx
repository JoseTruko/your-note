        ...
        <footer className={styles.footer}>
            <div className={styles.footerContent}>
                <div className={styles.footerSection}>
                    <div className={styles.logo}>
                        <h3 className={styles.logoText}>VisualNote</h3>
                        <p className={styles.logoDescription}>
                            La herramienta definitiva para organizar tus ideas y proyectos.
                        </p>
                    </div>
                </div>
                
                <div className={styles.footerSection}>
                    <h4 className={styles.sectionTitle}>Producto</h4>
                    <ul className={styles.linkList}>
                        ...
                        <li><a href="#actualizaciones" className={styles.footerLink}>Actualizaciones</a></li>
                ...
                <div className={styles.footerSection}>
                    ...
                    <ul className={styles.linkList}>
                        <li><a href="#documentacion" className={styles.footerLink}>Documentación</a></li>
                        <li><a href="#tutoriales" className={styles.footerLink}>Tutoriales</a></li>
                        <li><a href="#blog" className={styles.footerLink}>Blog</a></li>
                        <li><a href="#comunidad" className={styles.footerLink}>Comunidad</a></li>
                    </ul>
                </div>
                ...
                <div className={styles.footerSection}>
                    ...
                    <ul className={styles.linkList}>
                        ...
                        <li><a href="#estado" className={styles.footerLink}>Estado del Servicio</a></li>
            ...
            <div className={styles.footerBottom}>
                <div className={styles.copyright}>
                    <p>&copy; 2024 VisualNote. Todos los derechos reservados.</p>
                </div>
